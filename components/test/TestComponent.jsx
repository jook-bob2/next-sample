...
import { getExpireTime, getUserList } from '@/core/api/user/userApi'
...
export default function TestComponent() {
	 ...
	 */
	function handleClickBtnDate(date) {
		setStartDate(date)
	...
	async function testApi() {
		try {
			...
			console.log(response)
			try {
				const response2 = await getUserList()
	...
	return (
		<div style={styles.comm_wrap}>
			...
			<div style={styles.comm_item}>
				<h1>이벤트 버블링 테스트</h1>
				<Button size={'mini'} color="facebook" onClick={testApi}></Button>
			</div>
			{/* <div style={styles.comm_item}>
				<h1>[PieChart]</h1>
				<PieChart />
